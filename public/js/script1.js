...
//   const shoppingCart= document.querySelectorAll('.fa fa-shopping-cart');
//   shoppingCart.forEach(button => {
//     button.addEventListener('click',function(e){
//       e.preventDefault()

//       const ProductList= this.closest('.feature_item');
//       const ProductText = ProductList.querySelector('.featured__item__text')

//       const name= ProductText.getAttribute('data_name');
//       const price= ProductText.getAttribute('data_price');
